...
namespace RoboExtracaoProcesso.Classes
{
    public class HumanCoder
    {
        ...
        public string LastTaskId { get { return _LastTaskId; } }
        public ResponseState LastPostState { get { return _LastPostState; } }
        public string LastResponseText { get { return _LastResponseText; } }
        public string AccessKey { get { return _AccessKey; } }
        public string VendorKey { get { return _VendorKey; } }
        public string PostUrl { get { return _PostUrl; } }
        #endregion

        public HumanCoder(string ImagePostUrl, string Key, string PartnerVendorKey)
        {
            this._PostUrl = ImagePostUrl;
            this._AccessKey = Key;
            this._VendorKey = PartnerVendorKey;
        }
        public HumanCoder(string ImagePostUrl, string Key)
        {
            this._PostUrl = ImagePostUrl;
            this._AccessKey = Key;
            this._VendorKey = "";
        ...
        public bool SolveCaptcha(string img)
        {
